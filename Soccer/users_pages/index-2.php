		...
		*************************************-->
		<div id="tg-navigationm-mobile" class="tg-navigationm-mobile tg-navigation collapse navbar-collapse">
			...
			<div class="tg-colhalf">
				<ul>
					<li class="active">
						<a type="button" class="btn btn-seondary">Registeration</a>
					</li>
					<li>
						<a href="#" type="button" class="btn btn-primary">Juniors</a>
						
					</li>
					<li>
						<a href="#" type="button" class="btn btn-info">Seniors</a>
								...
								<div class="row">
									<div class="col-md-4 col-sm-12 col-xs-12">
										...
										<div class="tg-pointtable">
											<div class="tg-box">Tournament</div>
											<div class="tg-box2">Arnold Classic 2019</div>
										</div>
									</figure>
										<div class="tg-pointtable">
											<div class="tg-box">Date</div>
											<div class="tg-box2">17 to 19 May</div>
										</div>
										<div class="tg-pointtable">
											<div class="tg-box">Time</div>
											<div class="tg-box2">8:30 to 5:30 pm</div>
										</div>
										<div class="tg-pointtable">
											<div class="tg-box">Awards Ceremonet</div>
											<div class="tg-box2">19th May</div>
										</div>
										<div class="tg-pointtable">
											<div class="tg-box">Time</div>
											<div class="tg-box2">4:30:00 PM</div>
										</div>
									</div>
									<div class="col-md-4 col-sm-12 col-xs-12">
										<div class="tg-pointtable">
											<div class="tg-box">STATS % registration until closing</div>
											<div class="tg-box">7%</div>
										</div>
										<div class="tg-pointtable">
											<div class="tg-box">Current Players Registered</div>
											<div class="tg-box">11</div>
										</div>
										<div class="tg-pointtable">
											<div class="tg-box">Spaces Available</div>
											<div class="tg-box">165</div>
										</div>
										<div class="tg-pointtable">
											<div class="tg-box">Space left</div>
											<div class="tg-box">154</div>
										</div>
									</div>
									<div class="col-md-4 col-sm-12 col-xs-12">
										
										<div class="tg-pointtable">
											<div class="tg-box2" colsoan="2">
							...
							<div class="tg-pointstablewrapper">
								<div class="col-sm-8 col-xs-12">
									<div class="tg-pointstable">
										<div class="tg-section-heading"><h2>Record Table</h2>
											<a href="#" type="button" class="btn btn-primary">Juniors</a>
											<a href="#" type="button" class="btn btn-info">Seniors</a>
											<a href="registration.php" type="button" class="btn btn-warning">Registeration</a>
										</div>
										<div class="">
										...
										<div id="tg-pointstable-slider" class="tg-pointstable-slider">
											<div class="swiper-wrapper">
												<div class="swiper-slide">
													<div class="tg-pointtable">
														<div class="tg-box">U13 Boys</div>
														
													</div>
												</div>
												<div class="swiper-slide">
													<div class="tg-pointtable">
														<div class="tg-box">U13 Girls</div>
														
													</div>
												</div>
												<div class="swiper-slide">
													<div class="tg-pointtable">
														<div class="tg-box">U15 Boys</div>
														
													</div>
												</div>
												<div class="swiper-slide">
													<div class="tg-pointtable">
														<div class="tg-box">U15 Girls</div>
														
													</div>
												</div>
												<div class="swiper-slide">
													<div class="tg-pointtable">
														<div class="tg-box">U18 Boys</div>
														
													</div>
												</div>
												<div class="swiper-slide">
													<div class="tg-pointtable">
														<div class="tg-box">U18 Girls</div>
														
													</div>
												</div>
												<div class="swiper-slide">
													<div class="tg-pointtable">
														<div class="tg-box">Doubles</div>
														
													</div>
												</div>
												<div class="swiper-slide">
													<div class="tg-pointtable">
														<div class="tg-box">Women</div>
														
													</div>
												</div>
												<div class="swiper-slide">
													<div class="tg-pointtable">
														<div class="tg-box">Mens</div>
