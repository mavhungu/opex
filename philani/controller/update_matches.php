...
if($_POST['gender'] == "Female")
{
	...
	{		
		...
		$ref = mysqli_query($con, "SELECT * FROM ref WHERE email = '{$_SESSION['email']}' AND type = 'Juniors'");
		...
		if($save)
		{
		    ...
		    {
		        $r = rand();
		        $update = mysqli_query($con, "INSERT INTO ref VALUES ('{$_SESSION['email']}','{$r}', 'Juniors', '0')");
		    }
		?>
