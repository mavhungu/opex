      ...
      <div class="modal-content">
          <form action="modals/error_check.php" method="post">
            <div class="modal-header">
                <h4 class="modal-title">Please provide the information of the players</h4>
            	...
            	<table class="table table-bordered" id="dataTable" width="99%" cellspacing="0">                    	
					...
					?>
                        <tr>
                            ...
                            <td><input type="text" name="<?php echo "id_number".$i; ?>" required placeholder="Enter ID Number" class="form-control"></td>
                        </tr>
                        <?php endfor; ?>
                    </tbody>
				</table>          
